...
news_articles = [
    NewsArticle(title="New Study Shows Benefits of Exercise", author="John Smith",
    ...
    NewsArticle(title="Local Restaurant Wins Award for Best Pizza", author="Jane Doe",
    ...
    NewsArticle(title="New Technology Helps Blind People See", author="Bob Johnson",
    ...
    NewsArticle(title="City Council Approves New Bike Lanes", author="Alice Lee",
    ...
    NewsArticle(title="New Study Shows Benefits of Meditation", author="David Kim",
    ...
    NewsArticle(title="Local High School Wins State Championship", author="Emily Chen",
    ...
    NewsArticle(title="New Study Shows Benefits of Eating Vegetables", author="Michael Brown",
    ...
    NewsArticle(title="City Launches New Recycling Program", author="Sarah Kim",
    ...
    NewsArticle(title="New Technology Helps Deaf People Hear", author="Kevin Lee",
    ...
    NewsArticle(title="Local Artist Wins National Award", author="Olivia Wang",
                content="A local artist has won a national award for her work in painting, according to a panel of judges.", tags=["art", "awards"]),
    NewsArticle(title="New Study Shows Benefits of Reading", author="Sophia Miller",
    ...
    NewsArticle(title="City Council Approves New Dog Park", author="James Davis",
    ...
    NewsArticle(title="New Study Shows Benefits of Drinking Water", author="Daniel Wilson",
    ...
    NewsArticle(title="New Study Shows Benefits of Eating Fruit", author="Michael Brown",
    ...
    NewsArticle(title="City Launches New Bike Share Program", author="Sarah Kim",
    ...
    NewsArticle(title="New Study Shows Benefits of Eating Vegetables", author="Michael Brown",
                content="A new study has found that eating a diet rich in vegetables can improve overall health and reduce the risk of chronic diseases.", tags=["vegetables", "health"]),
    NewsArticle(title="City Council Approves New Recycling Program", author="Sarah Kim",
...
# Example responses
read_article_by_title.example = {"title": "New Study Shows Benefits of Exercise", "author": "John Smith",
                                 "content": "A new study has found that regular exercise can improve overall health and reduce the risk of chronic diseases.", "tags": ["exercise", "health"]}
