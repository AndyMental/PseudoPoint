...
def get_all_routers():
    return [
        ...
        {"router": ecommerce.router,
            "prefix": "/ecommerce", "tags": ["Ecommerce"]},
        ...
        {"router": reviews.router, "prefix": "/reviews",
            "tags": ["Movie Reviews"]},
        ...
        {"router": vehicles.router,
            "prefix": "/vehicles", "tags": ["Vehicles"]},
        {"router": trivia.router, "prefix": "/trivia", "tags": ["Trivia"]},
        {"router": wildlife.router,
            "prefix": "/wildlife", "tags": ["Wildlife"]},
        {"router": geographical.router,
            "prefix": "/geographical", "tags": ["Geographical"]},
        {"router": weight_conversion.router,
            "prefix": "/weight_conversion", "tags": ["Weight Conversion"]},
        {"router": historical_events.router,
            "prefix": "/historical_events", "tags": ["Historical Events"]},
        {"router": wine_ratings.router,
            "prefix": "/wine_ratings", "tags": ["Wine Ratings"]},
        {"router": quotes.router, "prefix": "/quotes", "tags": ["Quotes"]},
        {"router": celebrities.router,
            "prefix": "/celebrities", "tags": ["Celebrities"]},
